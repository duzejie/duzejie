...
![STA inputs and outputs](staio.JPG)

------

### Timing Report

![timing report](timingreport1.JPG)

![timing report](timingreport.JPG)
...
![latch vs flip flop, difference between latch and flip flop](latch.JPG)

#### D-Type Register or Flip-Flop, Edge-Triggered

Data captured on rising edge of clock, held for rest of the cycle
![latch vs flip flop, difference between latch and flip flop](flop.JPG)
...
![timing paths, sta](timingpaths.JPG)

------

### Timing Path Groups

![timing path groups, sta](timingpathgroups.JPG)
...
![crpr, clock reconvergence pessimism removal](crpr.JPG)
...
![recovery and removal timing](removal.JPG)
...
![bottleneck analysis](bottleneck.JPG)
...
- The technique of Borrowing Time from the shorter paths of the subsequent logic stages to the longer path is called Time Borrowing or Cycle Stealing
  ![time borrowing](timeborrowing.JPG)
...
![timing analysis, static timming analysis ](bps.JPG)