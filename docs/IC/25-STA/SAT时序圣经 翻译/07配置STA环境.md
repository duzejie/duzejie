...
![img](07配置STA环境/v2-aa744d6ffbef6109377a3eccda7e218d_1440w.jpg)图7-1
...
![img](07配置STA环境/v2-6e1ad5dbf33e4c8c136550a31b319aef_1440w.jpg)图7-2
...
![img](07配置STA环境/v2-dbbcd77f39398830ea5cf2fd2eb25bde_1440w.jpg)图7-3

以下是时钟约束的另一个示例，其中波形的边沿在一个周期的中间位置（见图7-4）。

![img](07配置STA环境/v2-d0c02747fa5844119df9c7e7195a1874_1440w.jpg)图7-4
...
![img](07配置STA环境/v2-516fe313698455d1d526b37d09993dc6_1440w.jpg)图7-5
...
![img](07配置STA环境/v2-6c5dab5ba4ba161baf81c50755916381_1440w.jpg)图7-6
...
![img](07配置STA环境/v2-f96ee253d5ab4344d609d25ead44dd52_1440w.jpg)图7-7
...
![img](07配置STA环境/v2-12998af38a47e4142c6e20f5e6b4afce_1440w.jpg)图7-8
...
![img](07配置STA环境/v2-c7004cb35ecb6cc694c7a0fb8573f446_1440w.jpg)图7-9
...
![img](07配置STA环境/v2-941547528f380cbca82879d15bf2b3d7_1440w.jpg)图7-10
...
![img](07配置STA环境/v2-c423248b15d63a8735f39e7c97cfdffc_1440w.jpg)图7-11
...
![img](07配置STA环境/v2-fd500c1fb9ceb87b41d91b8d99c0e497_1440w.jpg)图7-12
...
![img](07配置STA环境/v2-7f44f7cf3f9f2e084177458eef817bd3_1440w.jpg)图7-13
...
![img](07配置STA环境/v2-7aae184dbb9001688b317a5b0cd297c9_1440w.jpg)图7-14
...
![img](07配置STA环境/v2-d16d08f6864a33be0a8c5c02fa846b54_1440w.jpg)图7-15
...
![img](07配置STA环境/v2-24ae3783cf838e134c2d2b78a476b625_1440w.jpg)图7-16
...
![img](07配置STA环境/v2-67973f8c8d91e10d9977f44118aea458_1440w.jpg)图7-17
...
![img](07配置STA环境/v2-57fdab36496c9d5c1d365c97bb6b8a52_1440w.jpg)图7-18

### 衍生时钟的时钟延迟

也可以为衍生时钟指定时钟延迟，在衍生时钟上指定的源延迟还包括了从主时钟定义点到衍生时钟定义点的延迟。因此，由衍生时钟驱动的触发器的时钟引脚的总时钟延迟是主时钟源延迟、衍生时钟源延迟和衍生时钟网络延迟的总和。如下图7-19所示：

![img](07配置STA环境/v2-4df950c98fe52b60cfa72e2478a8b988_1440w.jpg)图7-19
...
![img](07配置STA环境/v2-3db3a3ad843d1528c0fa9a02ca77d63d_1440w.jpg)图7-20
...
![img](07配置STA环境/v2-f713ddf9c69f23bbe3ab321fb441dd5a_720w.jpg)图7-21
...
![img](07配置STA环境/v2-1113d503c83279b8ab7675d415989a0e_720w.jpg)图7-22
...
![img](07配置STA环境/v2-60b45c8d7e395dc89d5c52efad0d7717_720w.jpg)图7-23
...
![img](07配置STA环境/v2-5fbca91a1e5e88caff80703df074f522_720w.jpg)图7-24
...
![img](07配置STA环境/v2-6d4f02368e4d12bbd76106cb750dfdc2_720w.jpg)图7-25
...
![img](07配置STA环境/v2-e18974487168538c443b0ea0df357384_720w.jpg)图7-26
...
![img](07配置STA环境/v2-36074bc598c2171aa333caaa1c264150_720w.jpg)图7-27
...
![img](07配置STA环境/v2-a753d1df32090d6b3274a51125074ccb_720w.jpg)图7-28
...
![img](07配置STA环境/v2-cb03063702ee294420e80a17f10bc305_720w.jpg)图7-29
...
![img](07配置STA环境/v2-8a101572b7131c2329492842e143c39d_720w.jpg)图7-30
...
![img](07配置STA环境/v2-4733861a936ea7709cd63288f7f2fad6_720w.jpg)图7-31
