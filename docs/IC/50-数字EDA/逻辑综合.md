...
![synthesis flow](synthesisflow.JPG)
...
![topographical synthesis input](topographicalsynthesis.JPG)
...
![logicsynthesis_analyze&elaborate](synthesisflow_analyze&elaborate.JPG)
...
![Operating, synthesis](operating.JPG)
...
![reg2reg](reg2reg.JPG)A timing path example for setup is given for a register to register path

![synthesis steps](setupcheck.JPG)Waveform for setup timing check.
...
![logic synthesis](majordrc.JPG)



### Major Design Optimization Constraints 

![major design optimization](majordpc.JPG)
...
![clock latency](clocklatencyuncertaintytransition.JPG)
...
![synthesis in physical design](compilestrategy.JPG)

------

### DC optimization flow 

![synthesis in physical design](dcoptflow.JPG)
...
- The group_path command can be used to create path groups. The group_path command allows you to
	...
	- Optimize all paths
	![synthesis in physical design](opt.jpg)
...
- Design Compiler supports two methods for calculating the maximum delay cost:
	...
	- Critical Range Negative Slack Method
           ![synthesis in physical design](eq1.JPG)
...
- Using the critical range negative slack method, the equation for the maximum delay cost is:
  ...
  ![[Pasted image 20230925143952.png]]
...
![optimization](opt1.JPG)

![optimization](opt2.JPG)
...
![grouping in logic synthesis](grouping.JPG)
