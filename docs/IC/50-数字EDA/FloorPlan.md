...
​      ![floorplan flowchart](attachments/FloorPlan/floorplanflow.png)
...
- Mix of both: partially abutted with some channels.
  ...
  ![floorplan types, abutted non abutted and mix](attachments/FloorPlan/floorplantechniques.png)
...
- Slanting lines in the side of the cell rows denote the Cell Orientation ![utilization in floorplan, physicaldesign](attachments/FloorPlan/utilization.jpg) ![utilization in floorplan, physicaldesign](attachments/FloorPlan/utilization1.jpg)
     Butt and flip is Most common because of better space utilization

| Core to Pad/ IO spacingCore to IO clearanceUsed </br> for Placing IOs and Power Ring | ![core to io spacing in floorplan](attachments/FloorPlan/corearea.jpg) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |  ![io spaching in floorplan](attachments/FloorPlan/aspectratio.jpg)                              |
...
![ratio is floorplan, physical design](attachments/FloorPlan/standardcell.jpg)
...
- Unplaced Port is not represented in the Layout
      ![io placement in physical ddesign](attachments/FloorPlan/ioplacement.jpg)
...
- No of Core Power Pads needed:     ![core power pads in physical design](attachments/FloorPlan/corepowerpads.jpg)
...
![macro placement, floorplanning, physical design](attachments/FloorPlan/macrospacing.jpg)
...
- Provide necessary Blockages around the Macro ![macro placement, floorplanning, physical design](attachments/FloorPlan/macroplacement.jpg)
...
- blockages will not be guiding the tool to place the std cells at some particular area, but it won't allow the tool to place the std cell in the blocked area.
  ![blockages in physical design](attachments/FloorPlan/blockages.jpg)
...
​               ![keepout margin, halo in physical design](attachments/FloorPlan/halo.jpg)
...
- Macros of same partition which are placed far apart can cause Timing Violation
  ...
  ![floorplanning, physical design](attachments/FloorPlan/floorplan.jpg)
