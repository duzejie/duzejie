...
![image-20200613211201429](attachments/算法与数据结构笔记/a82e77240b47d7e14a0796a5b6b35e0f_MD5.png)
...
![image-20200402115827829](attachments/算法与数据结构笔记/fe9e58e092855d1032ee3b6fa24343c8_MD5.png)
...
![image-20200402120447323](attachments/算法与数据结构笔记/0d39c0ff290b0ab1ab5765beb1212556_MD5.png)
...
![image-20200402121314240](attachments/算法与数据结构笔记/b471acb853ab59cb8c2c0373ad5eccf0_MD5.png)

* 反证法证明

### 1.2 递归简论

![image-20200402131718991](attachments/算法与数据结构笔记/32cc7b6b729211e7427f82ade36e22e4_MD5.png)
...
![image-20200401201852656](attachments/算法与数据结构笔记/5952f89fc60835f2df69eb9d9507bef8_MD5.png)

> 理解下面三点：

![image-20200401201304869](attachments/算法与数据结构笔记/bd71d437b61ea435c2011f540c63164e_MD5.png)
...
![](attachments/算法与数据结构笔记/e47eb0a169c3d09a804c6735c1f3a877_MD5.png)



### 2.2 数学基础

![image-20200402133657321](attachments/算法与数据结构笔记/2891d900d06b99be9c6e4dae8dad2b7b_MD5.png)



### 2.3 计算模型

![image-20200402133836771](attachments/算法与数据结构笔记/e2d1d5130f43add887830142d1118443_MD5.png)
...
![image-20200401203235581](attachments/算法与数据结构笔记/101a28697dde3c083ab11402136af228_MD5.png)

所以要进行事前预估，事前预估算法时间开销 T(n) 与问题规模n的关系 (T表示“time”)

![](attachments/算法与数据结构笔记/d784e80b9cbfbea55a3d6d9a8d65a54c_MD5.png)

**时间复杂度量级比较**
$$
O(1)<O(log_2n)<O(n)<O(nlog_2n)<O(n^2)<O(n^3)<O(2^n)<O(n!)<O(n^n)
$$
![](attachments/算法与数据结构笔记/7f46253bec192d79aa75c8ff1eac5410_MD5.png)



![](attachments/算法与数据结构笔记/1a3643bfbeeaa8e59952b34a9815540c_MD5.png)
...
![](attachments/算法与数据结构笔记/392bed29c75190c924246ec9b8550395_MD5.png)
...
![image-20200402152845271](attachments/算法与数据结构笔记/c505e8da5572673c771b59de0cf0240a_MD5.png)
...
![image-20200401205632451](attachments/算法与数据结构笔记/7daf840a530409880af1f6a19be2d031_MD5.png)
...
![image-20200407164948729](attachments/算法与数据结构笔记/77b761d2bda20385d6c82988c9eeb02c_MD5.png)
...
![image-20200407165318650](attachments/算法与数据结构笔记/7ef9272006e0d0f41619bdda2198985b_MD5.png)

## 第四章 栈和队列

![](attachments/算法与数据结构笔记/9e0fe28e1cf9825d72c0a435c13c035d_MD5.png)
...
![](attachments/算法与数据结构笔记/1029b21ba6daa24aa1eb3139dbbc7653_MD5.png)
...
![](attachments/算法与数据结构笔记/07a42ee2fd6a32d1df5d49202f7dba78_MD5.png)
...
![](attachments/算法与数据结构笔记/8ae45363832ff1af481f5a63bab980e4_MD5.gif)
...
![image-20200414113433980](attachments/算法与数据结构笔记/306694230637f73b42cb776323c7dd4b_MD5.png)
...
![](attachments/算法与数据结构笔记/f9545161fb83d261c7f34339c29f564c_MD5.gif)
...
![](attachments/算法与数据结构笔记/bc1017b28085843c17d4ab41cca74edf_MD5.gif)
...
![image-20200414114918938](attachments/算法与数据结构笔记/40970755bbf3d561eb93579109396ca6_MD5.png)
...
![image-20200414115223369](attachments/算法与数据结构笔记/9c933da7538ed64213cab424ea3968f3_MD5.png)
...
![](attachments/算法与数据结构笔记/24616acebbd3fe27a84fe88a309a7b1a_MD5.gif)
...
![](attachments/算法与数据结构笔记/c0048c693cebbd06dd980dde2abc8767_MD5.gif)
...
![image-20200414105635398](attachments/算法与数据结构笔记/610095d9065cf1c35e8835d26f6f4fb5_MD5.png)
...
![image-20200414105818806](attachments/算法与数据结构笔记/716da50d2f030ea64a0ac6aaa16550c5_MD5.png)
...
![image-20200414110735223](attachments/算法与数据结构笔记/b66b05a5988d32e85a67954e5718c7f2_MD5.png)

计算 key = 37 时，发现 f(37) = 1，此时就与 25 所在的位置冲突。

于是我们应用上面的公式 f(37) = (f(37)+1) mod 12 = 2。于是将 37 存入下标为 2 的位置。这其实就是房子被人买了于是买下一间的作法：

![image-20200414110824613](attachments/算法与数据结构笔记/7206382c52c4c0a6c984e36d71b764d3_MD5.png)

接下来 22,29,15,47 都没有冲突，正常的存入：

![image-20200414110913189](attachments/算法与数据结构笔记/dd0669ebc8d7e686048f817931c76bc3_MD5.png)
...
![image-20200414110949385](attachments/算法与数据结构笔记/89de9e059c6f6217cfc1d309c60e4db4_MD5.png)
...
![image-20200414111305968](attachments/算法与数据结构笔记/3fd72e448d268d4e80c01879c2ead1bd_MD5.png)
...
![](attachments/算法与数据结构笔记/95a9c8af532be06842700b4f877717cc_MD5.png)

计算$$\large a_{i,j}$$在压缩矩阵中的下标

![](attachments/算法与数据结构笔记/80559c0e13e006711d4eb275a37b422b_MD5.png)

### 三角矩阵

![](attachments/算法与数据结构笔记/746b1e2255203e49d0cca09890c8de4d_MD5.png)

+1个空间是为了存储这个常数c

![](attachments/算法与数据结构笔记/edf3e2ac8d1616f3297e97fb62062132_MD5.png)

![](attachments/算法与数据结构笔记/096ebafaf9c8591190ad0ea6fb51ec36_MD5.png)

### 三对角矩阵

![](attachments/算法与数据结构笔记/3f1750a85b16d80d94717d9c8f48294e_MD5.png)
...
![](attachments/算法与数据结构笔记/e4a222a9b655b753f639fb5b1997861d_MD5.png)
...
![](attachments/算法与数据结构笔记/aba804df52fa08ac7111fafaae090b35_MD5.png)

### 手搓步骤

计算模式串中所有前缀的部分匹配值

![](attachments/算法与数据结构笔记/9abc86deee87ec7f025b0bc09277c87e_MD5.png)
