...
![image-20200402120447323](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/0d39c0ff290b0ab1ab5765beb1212556_MD5.png)
...
![image-20200402133657321](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/2891d900d06b99be9c6e4dae8dad2b7b_MD5.png)
...
![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/9e0fe28e1cf9825d72c0a435c13c035d_MD5.png)
...
![image-20200414115223369](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/9c933da7538ed64213cab424ea3968f3_MD5.png)
...
![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/24616acebbd3fe27a84fe88a309a7b1a_MD5.gif)
...
![image-20200414105635398](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/610095d9065cf1c35e8835d26f6f4fb5_MD5.png)
...
![image-20200414105818806](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/716da50d2f030ea64a0ac6aaa16550c5_MD5.png)
...
![image-20200414110735223](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/b66b05a5988d32e85a67954e5718c7f2_MD5.png)

计算 key = 37 时，发现 f(37) = 1，此时就与 25 所在的位置冲突。

于是我们应用上面的公式 f(37) = (f(37)+1) mod 12 = 2。于是将 37 存入下标为 2 的位置。这其实就是房子被人买了于是买下一间的作法：

![image-20200414110824613](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/7206382c52c4c0a6c984e36d71b764d3_MD5.png)

接下来 22,29,15,47 都没有冲突，正常的存入：

![image-20200414110913189](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/dd0669ebc8d7e686048f817931c76bc3_MD5.png)
...
![image-20200414110949385](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/89de9e059c6f6217cfc1d309c60e4db4_MD5.png)
...
![image-20200414111305968](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/3fd72e448d268d4e80c01879c2ead1bd_MD5.png)
...
![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/95a9c8af532be06842700b4f877717cc_MD5.png)

计算$$\large a_{i,j}$$在压缩矩阵中的下标

![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/80559c0e13e006711d4eb275a37b422b_MD5.png)

### 三角矩阵

![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/746b1e2255203e49d0cca09890c8de4d_MD5.png)

+1个空间是为了存储这个常数c

![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/edf3e2ac8d1616f3297e97fb62062132_MD5.png)

![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/096ebafaf9c8591190ad0ea6fb51ec36_MD5.png)

### 三对角矩阵

![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/3f1750a85b16d80d94717d9c8f48294e_MD5.png)
...
![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/e4a222a9b655b753f639fb5b1997861d_MD5.png)
...
![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/aba804df52fa08ac7111fafaae090b35_MD5.png)

### 手搓步骤

计算模式串中所有前缀的部分匹配值

![](docs/software-engineering/03.算法、数据结构/attachments/算法与数据结构笔记/9abc86deee87ec7f025b0bc09277c87e_MD5.png)
