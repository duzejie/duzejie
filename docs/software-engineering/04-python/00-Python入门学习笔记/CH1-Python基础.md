...
![Python3](attachments/CH1-Python基础/b2789b8978ece738623ab847026d818a_MD5.png)
...
![image-20200517223148826](attachments/CH1-Python基础/090bfb864716ec1257ff0fe04d1297f4_MD5.png)

（2）安装 Python

安装时注意下图勾选部分一定要勾选：

![image-20200517223527044](attachments/CH1-Python基础/e6d894dabb03513f85c2af19e9b4d19f_MD5.png)
...
![image-20200517223348661](attachments/CH1-Python基础/19b3ee838deca857d0abae84a9e5416c_MD5.png)

（2）安装 PyCharm

设置安装路径之后，一直点 next 即可。

![image-20200517224622654](attachments/CH1-Python基础/ebaade8a489fdb3f636a3618eaf5bfae_MD5.png)
...
✨ 使用文档可参考我的笔记：[Jupyter - notebook 使用指南](../Python/Jupyter-notebook使用指南.md)
...
![评估函数](attachments/CH1-Python基础/e368561668348301521d51a28f210c60_MD5.png)
...
![image-20200517225658342](attachments/CH1-Python基础/e522b0278f725075bb90c507b847051e_MD5.png)
...
![image-20200610194537419](attachments/CH1-Python基础/2b8f2b5f39b7a04410b8c8480803c8ad_MD5.png)
...
![image-20200610194823007](attachments/CH1-Python基础/5908e44d84f5af063bcf09fc0a338b5b_MD5.png)
...
![image-20200610222139397](attachments/CH1-Python基础/ffe074176b15107b463245e5abce2206_MD5.png)
...
![image-20200611164619720](attachments/CH1-Python基础/6303e76e3c09757c6a692d9064a41c76_MD5.png)
...
![image-20200611165043478](attachments/CH1-Python基础/b4d869422e88252f279b22de10574b9f_MD5.png)
...
![image-20200611170358099](attachments/CH1-Python基础/68d297432b1de92739495aa8c8337c39_MD5.png)

当我们把 list 的元素 `'A'` 和 `'B'` 修改为 `'X' `和 `'Y'` 后，tuple 变为：

![image-20200611170515905](attachments/CH1-Python基础/afee589f728c6bb92be1c8ee3409c384_MD5.png)
...
![image-20200611172243031](attachments/CH1-Python基础/eab339551d9698e03cc513ded3dc65c0_MD5.png)
...
![image-20200611173457932](attachments/CH1-Python基础/dc776ced2629f2282f11073ca36b7bcd_MD5.png)
...
![image-20200611175123150](attachments/CH1-Python基础/51ddb6f3e4d9f269a1aab670b9bb94f5_MD5.png)

当我们调用 `a.replace('a', 'A')` 时，实际上调用方法 `replace` 是作用在字符串对象 `'abc'` 上的，而这个方法虽然名字叫 `replace`，但却没有改变字符串 `'abc'` 的内容。相反，`replace` 方法创建了一个新字符串 `'Abc'` 并返回，如果我们用变量 `b` 指向该新字符串，就容易理解了，变量 `a` 仍指向原有的字符串 `'abc'`，但变量 `b` 却指向新字符串 `'Abc'` 了：

![image-20200611175231653](attachments/CH1-Python基础/8fbdd8bb7b09a78d1964f390207cd8ad_MD5.png)
...
![保留字](attachments/CH1-Python基础/67b792140b1c8e5fe173dcecceab9fb2_MD5.png)
...
- 执行`a = 'ABC'`，解释器创建了字符串`'ABC'`和变量`a`，并把`a`指向`'ABC'`：
  ...
  ![img](attachments/CH1-Python基础/d9f3b9461c96fce6b900ddb1186a3c1c_MD5.png)

- 执行`b = a`，解释器创建了变量`b`，并把`b`指向`a`指向的字符串`'ABC'`：

  ![img](attachments/CH1-Python基础/93315df368475d6dc80760976343c592_MD5.png)

- 执行`a = 'XYZ'`，解释器创建了字符串'XYZ'，并把`a`的指向改为`'XYZ'`，但`b`并没有更改：

  ![img](attachments/CH1-Python基础/89f4d9e8f19677307415285a99e42838_MD5.png)
...
![image-20200623172824974](attachments/CH1-Python基础/167d4b44a3ae33432d1f0e82888709c9_MD5.png)
...
![image-20200623173834408](attachments/CH1-Python基础/1ad97a3a93194bb15114025411a32930_MD5.png)
...
![image-20200623174150679](attachments/CH1-Python基础/88e7c70760a05c105c4f13a74afb5717_MD5.png)

浏览网页的时候，服务器会把动态生成的 Unicode 内容转换为 UTF-8 再传输到浏览器：

![image-20200623174254190](attachments/CH1-Python基础/87853fbfcc7a3a5cfcac3ebddfc68394_MD5.png)
...
![image-20200623175618702](attachments/CH1-Python基础/6f08ab896874be9e85c5fe3940f21862_MD5.png)

如果`bytes`中只有一小部分无效的字节，可以传入`errors='ignore'`忽略错误的字节：

![image-20200623175706636](attachments/CH1-Python基础/f556cfccff519dd6586247f0076929de_MD5.png)
...
![image-20200623180524717](attachments/CH1-Python基础/962a25d5fd5307fc6e6a2291e8173f15_MD5.png)
...
![image-20200623181028546](attachments/CH1-Python基础/76c7f33b9563367a37df44f92c18558a_MD5.png)
