...
![图10-1 分组聚合演示](docs/software-engineering/04-python/Python数据分析/attachments/CH10-数据聚合与分组运算/c359b8fb4cf8429d88260a14a06a0af3_MD5.png)
...
![表10-1 经过优化的groupby方法](docs/software-engineering/04-python/Python数据分析/attachments/CH10-数据聚合与分组运算/9d040f7530ee9df82097345616f002f4_MD5.png)
...
![图10-2 分组聚合示例](docs/software-engineering/04-python/Python数据分析/attachments/CH10-数据聚合与分组运算/c359b8fb4cf8429d88260a14a06a0af3_MD5.png)
...
![表10-2 pivot_table的选项](docs/software-engineering/04-python/Python数据分析/attachments/CH10-数据聚合与分组运算/d3fdbd9371a159ad4302dabcd419ba60_MD5.png)
