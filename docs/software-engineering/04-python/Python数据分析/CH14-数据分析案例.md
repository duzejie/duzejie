...
![图14-1 usa.gov示例数据中最常出现的时区](attachments/CH14-数据分析案例/7bb463beb3436c8b35de13e70a35b45c_MD5.png)
...
![图14-2 最常出现时区的Windows和非Windows用户](attachments/CH14-数据分析案例/2920975d585255c0d30fa79ca3f27311_MD5.png)
...
![图14-3 最常出现时区的Windows和非Windows用户的百分比](attachments/CH14-数据分析案例/78f25d784f6a4df9f1a7ca9f0ab93a95_MD5.png)
...
![图14-4 按性别和年度统计的总出生数](attachments/CH14-数据分析案例/783610d232138df805f1c65eacdeff7a_MD5.png)
...
![图14-5 几个男孩和女孩名字随时间变化的使用数量](attachments/CH14-数据分析案例/cbd7cc2745adb79da655a3788a393d19_MD5.png)
...
![图14-6 分性别统计的前1000个名字在总出生人数中的比例](attachments/CH14-数据分析案例/167de4cde19322ddd5557317820e1b3f_MD5.png)
...
![图14-7 按年度统计的密度表](attachments/CH14-数据分析案例/7b290dec3885bd86e0be7b0809a83de0_MD5.png)
...
![图14-8 男孩女孩名字中各个末字母的比例](attachments/CH14-数据分析案例/5faf72ded92d6c0212b9e5d1e3dd681b_MD5.png)
...
![图14-9 各年出生的男孩中名字以d/n/y结尾的人数比例](attachments/CH14-数据分析案例/b00e4aea7fb1150b7ba0e4922eeaafce_MD5.png)
...
![图14-10 各年度使用“Lesley型”名字的男女比例](attachments/CH14-数据分析案例/214eb4072ff59eaa18dff08923cc8337_MD5.png)
...
![图片14-11 根据营养分类得出的锌中位值](attachments/CH14-数据分析案例/5387b49f436c2d9906ebf8496d85e818_MD5.png)
...
![图14-12 对各党派总出资额最高的职业](attachments/CH14-数据分析案例/61952db4b00a73a53f8ed23055509d79_MD5.png)
...
![图14-13 两位候选人收到的各种捐赠额度的总额比例](attachments/CH14-数据分析案例/beddafca4b88acc89dbd561920e4a11f_MD5.png)
