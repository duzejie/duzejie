...
![表8-1 不同的连接类型](docs/software-engineering/04-python/Python数据分析/attachments/CH08-数据规整：聚合、合并和重塑/b7ba71342a76f16a996e6b4291c9e641_MD5.png)
...
![](docs/software-engineering/04-python/Python数据分析/attachments/CH08-数据规整：聚合、合并和重塑/fde7a95e4f1b11fe63dfe6be9423f55b_MD5.png)

![](docs/software-engineering/04-python/Python数据分析/attachments/CH08-数据规整：聚合、合并和重塑/1f746bc4a0b2e2b74b2655beb89614a8_MD5.png)
...
![表8-3 concat函数的参数](docs/software-engineering/04-python/Python数据分析/attachments/CH08-数据规整：聚合、合并和重塑/4b4741925abec2938f6959b168ae5faf_MD5.png)
