...
![图9-1 简单的线图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/17e18c0d32ea60c8d47e4827408d712d_MD5.png)
...
![图9-2 带有三个subplot的Figure](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/2c5d84130c9177dc111c35f8b1f7a73a_MD5.png)
...
![图9-3 绘制一次之后的图像](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/758eabb8d86a07e1312cd732b704b7de_MD5.png)
...
![图9-4 继续绘制两次之后的图像](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/7cdf5844a4fbd8027633ba23198a9a80_MD5.png)
...
![表9-1 pyplot.subplots的选项](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/b3384545cefeb238ac8d692565c4be2f_MD5.png)
...
![图9-5 各subplot之间没有间距](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/06ae9bd8b680e346fade083a676b7881_MD5.png)
...
![图9-6 带有标记的线型图示例](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/e73f86c5bce089f3390af0bc502f5569_MD5.png)
...
![图9-7 不同drawstyle选项的线型图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/46c802396360361218b9ea2ad2b83595_MD5.png)
...
![图9-8 用于演示xticks的简单线型图（带有标签）](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/5314236349bc5332ac4ced945c0bf41b_MD5.png)
...
![图9-9 用于演示xticks的简单线型图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/e56c9ffbc0d3d730ff276b448523ed80_MD5.png)
...
![图9-10 带有三条线以及图例的简单线型图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/468d593e60f74e9242066de1c335f6fa_MD5.png)
...
![图9-11 2008-2009年金融危机期间的重要日期](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/2f77c2abcafdf4e75acae0ae563a610d_MD5.png)
...
![图9-12 由三个块图形组成的图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/c8e46dc49dd18d2bdafcab87d00c9c9f_MD5.png)
...
![表9-2 Figure.savefig的选项](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/5f8b505531e52d8961b4a5a7f6b3be63_MD5.png)
...
![图9-13 简单的Series图表示例](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/dc8fa56becc6a68446aaaa3d343d1d84_MD5.png)
...
![](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/f06dad498e7fbf7aca8bf4dc1f74b56a_MD5.png)

![表9-3 Series.plot方法的参数](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/fbfee596490a2abbbcb5f0c056283330_MD5.png)
...
![图9-14 简单的DataFrame绘图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/755a275cd8576cf3afc66a8a9561ac97_MD5.png)
...
![表9-4 专用于DataFrame的plot参数](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/8ddfa81550ac0bd692aab45cad09acdc_MD5.png)
...
![图9-15 水平和垂直的柱状图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/94c389686ec53d36194e1e88896c1530_MD5.png)
...
![图9-16 DataFrame的柱状图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/6a68c1d00b5ac51fc0b2fc7c62103bcb_MD5.png)
...
![图9-17 DataFrame的堆积柱状图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/d4442efe53a36a892b5e543a3ffe8619_MD5.png)
...
![图9-18 每天各种聚会规模的比例](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/165e7b51984e184aa79c5564dc710211_MD5.png)
...
![图9-19 小费的每日比例，带有误差条](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/24750ecc82194b14df5784e3f938f65a_MD5.png)
...
![图9-20 根据天和时间的小费比例](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/05a9f05463d0c98c86b2e0e12dbdc8ba_MD5.webp)
...
![图9-21 小费百分比的直方图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/440bbbf03e90c502e8cb869d38676cbc_MD5.png)
...
![图9-22  小费百分比的密度图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/d9055d2b8ae660a2d2d9d1fc23b6f0cc_MD5.png)
...
![图9-23 标准混合密度估计的标准直方图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/e6bbbfa54dfc27544720c77b623fc350_MD5.png)
...
![图9-24 seaborn的回归/散布图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/b80865bbfbefb22ecc72bb8664b302b9_MD5.png)
...
![图9-25 statsmodels macro data的散布图矩阵](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/05a9c0aab78104b3e70d95929e3a40e0_MD5.png)
...
![图9-26 按照天/时间/吸烟者的小费百分比](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/65f550b03409a2151d68e705031dfcd1_MD5.png)
...
![图9-27 按天的tip_pct，通过time/smoker分面](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/00c120429625bf69a1765c8e4948afb3_MD5.png)
...
![图9-28 按天的tip_pct的盒图](docs/software-engineering/04-python/Python数据分析/attachments/CH09-绘图和可视化/1df8d1b70daf5f282e7c4ad7225d9f56_MD5.png)
